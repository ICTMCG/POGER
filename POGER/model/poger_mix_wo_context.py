...
class Model(nn.Module):
    ...
    def forward(self, prob_feature, target_prob_mask, target_prob_idx):
        ...
        # classify
        output = self.classifier(target_prob_feature)  # (batch_size, 10, nclasses)
        # mean
...
class Trainer(TrainerBase):
    ...
    def get_loss(self, batch):
        ...
        output = self.model(prob_feature, target_prob_mask, target_prob_idx)
